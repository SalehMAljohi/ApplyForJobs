...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(a =>!a.Name.Contains("Adminsitrators")).ToList(),
                                                                              "Name", "Name"); //نسوي خيارات
            if (ModelState.IsValid)
            {
        ...
        public ActionResult EditProfile(EditProfileViewModel Profile)
        {
            ...
            {
                ViewBag.Message = "رجاء ادخل كلمة السر الحالية الصحيحة";
            }
            else
            {
                var PasswordHash = UserManager.PasswordHasher.HashPassword(Profile.NewPassword);
